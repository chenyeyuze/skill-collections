...
* [gource](https://github.com/acaudwell/Gource) 版本信息可视化
...
* [vConsole](https://github.com/WechatFE/vConsole) 内嵌调试工具

## 前端测试工具
* [f2eTest](https://github.com/alibaba/f2etest) 跨终端测试

## 网页客户端
* [Apache Guacamole](http://guacamole.incubator.apache.org/)
* [cmdrjs](https://github.com/cmdrjs/cmdrjs)
* [xTerm.js](https://github.com/sourcelair/xterm.js)
## <a name="other">其他类</a>
* [Ink](https://github.com/sapo/Ink/) 响应式页面框架
...
* [xregexp](https://github.com/slevithan/xregexp) 正则表达式处理
* [mathjax](https://www.mathjax.org/) 数学公式显示
